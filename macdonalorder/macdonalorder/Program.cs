...
namespace macdonalorder
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            List<string> shoppingcart = new List<string>(); // dynamic array 
            while (true)
            {
                ...
                if (int.TryParse(item1, out itemid1)) // if customer enter number true it will add item price to total
                {
                    ...
                    shoppingcart.Add($"itemid {itemid1} {itemname[itemid1 - 1]}  ${price[itemid1 - 1]}"); // filling dynamic array
                    i++; // counter in case
                }
                else
                {
            ...
            foreach (string nm in shoppingcart) { 
